...
public class WhiteListAdapter extends RecyclerView.Adapter<WhiteListAdapter.MyViewHolder>{
    ...
    public WhiteListAdapter(Context context, ArrayList<AppInfo> list) {
    ...
    @NonNull
    @Override
    public WhiteListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.one_app_view_for_white_list, parent, false);
        WhiteListAdapter.MyViewHolder holder = new WhiteListAdapter.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull WhiteListAdapter.MyViewHolder holder, int position) {
